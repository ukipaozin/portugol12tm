programa {
  ...
  inteiro esc, valor_sorteado, valor_inicial, valor_final, sorteios
  ...
  funcao inicio() {
    ...
    escolha (esc){
      ...
      pare
      caso 3:
      escreva("Insira o valor minimo: ")
		  leia(valor_inicial)

		  escreva("Insira o valor maximo: ")
		  leia(valor_final)

		  escreva("Quantos valores vao ser sorteados: ")
		  leia(sorteios)
